    ...
    <section class="page-content">
        <div class="container">
            <div class="title-wrap">
                <h2 class="title title-winners__left"><a
                        href="/winners"><?php if ($params['winnersWeek']) echo $params['winnersWeek']['Title']; else echo "Победителей пока нет" ?></a>
                </h2>
...
setTimeout($('#member" . $params['id'] . "').fancybox({
        'transitionIn': 'none',
        'transitionOut': 'none',
        padding: 60,
        arrows: true,}).click(),1000)
